...
@interface ZMSaleViewController () <UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic, strong) NSMutableArray *dataArr;
// 商品Id 商品的唯一识别方式
@property (nonatomic, strong) NSString *itemId;
@end

@implementation ZMSaleViewController
...
//    [parameters setObject:@"20" forKey:@"query_data"];
    [parameters setObject:[NSNumber numberWithInt:6] forKey:@"query_type"];
